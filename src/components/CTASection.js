    ...
    <div className="relative overflow-hidden rounded-lg p-8 my-6 text-center border border-[rgba(231,0,115,0.2)] bg-[rgba(231,0,115,0.04)]">
      ...
      <div className="flex gap-3 justify-center flex-wrap relative">
        <Link
          ...
          className="bg-[#E70073] text-white hover:text-white px-6 py-2.5 rounded-sm font-medium text-sm hover:no-underline hover:opacity-80 transition-opacity"
        >
          Start Building Free
        </Link>
        <Link
          to="mailto:team@candidelabs.com"
          className="border border-[rgba(255,255,255,0.2)] dark:text-white dark:hover:text-white text-black hover:text-black px-6 py-2.5 rounded-sm font-medium text-sm hover:no-underline hover:opacity-70 transition-opacity"
        >
          Contact Sales
        </Link>
      </div>
