...
InstaGas is a **no-code** platform that allows you to sponsor gas fees for end-users by
...
* Lending protocols
* Web3 games
* NFTs Collections and marketplaces
* And many more..
...
Learn more in details about [Gas Policies and Rules](/instagas/gas-policies) in the next page.


## Support

Have any questions? We're here to help. [Get in touch](https://cal.com/candidelabs/30mins) with the founders who will personally guide you through setting up a gas policy and get personalized assistance.
