...
**Holesky Bundler URL**: https://holesky.voltaire.candidewallet.com/rpc

EIP-7702 support is added with the upcoming EntryPoint V0.8 Release. The main ERC-4337 RPC call are `eth_estimateUserOperationGas` and `eth_sendUserOperation`, 
which takes a UserOperation structure. 

In order to support EIP-7702, we add a new json element named `eip7702Auth`, to hold the eip-7702 auth tuple items. The recovered address MUST be the sender of this UserOperation.

:::note
Candide released its EIP-7002 Bundler support on Holesky Network on EntryPoint v0.7 as an experimental release, until the official deployment and audits of EntryPoint v0.8 and Pectra upgrade are completed
:::
...
```json
{
  ...
  [{
      ...
      'signature': '0xd2614025fc173b86704caf37b2fb447f7618101a0d31f5f304c777024cef38a060a29ee43fcf0c46f9107d4f670b8a85c2c017a1fe9e4af891f24f0be6ba5d671c',
      'factory': None,
      'factoryData': None,
      'paymaster': None,
