...
- **Transaction Abstraction**
  - [Automate transactions](/wallet/plugins/allowance) with Spending Limits. Offer subscriptions, reccuring or scheduled payments.
...
Candide is available on all major EVM equivalent networks. If you would like to see a network supported, [reach out to us](https://t.me/heymarcopolo).
...
- Join our Discord community [here](https://discord.gg/7R4g9XcxDQ)
- Send us a tweet or DM us [@candidelabs](https://twitter.com/candidelabs)
