...
Additionally, many of these errors will be accompanied by [an extra error message provided by the Entrypoint](/wallet/technical-reference/entrypoint-error-codes/).
