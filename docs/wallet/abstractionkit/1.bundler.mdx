...
import { userOperationReturnParamsV06, userOperationParamV07, userOperationParamV08, userOperationReceiptResultType } from '/src/data/userOperation';
...
Returns the chain ID of the network the bundler is operating on.
...
[eth_chainId](/wallet/bundler/rpc-methods/#eth_chainid)
...
[eth_supportedEntryPoints](/wallet/bundler/rpc-methods/#eth_supportedentrypoints)
...
#### Usage
See a full example in [getting-started guide](/wallet/guides/getting-started/)
...
<TabItem value="Param Type" label="Param Type">
  ...
  UserOperationV8 / UserOperationV9
  <DataTable items={userOperationParamV08} />
  UserOperationV7
...
[eth_estimateUserOperationGas](/wallet/bundler/rpc-methods/#eth_estimateuseroperationgas)
...
[eth_sendUserOperation](/wallet/bundler/rpc-methods/#eth_senduseroperation)
...
[eth_getUserOperationByHash](/wallet/bundler/rpc-methods/#eth_getuseroperationbyhash)
...
[eth_getUserOperationReceipt](/wallet/bundler/rpc-methods/#eth_getuseroperationreceipt)
