...
#### Source code
[createUserOperationHash](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[createPackedUserOperationV6](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[createPackedUserOperationV7](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[fetchAccountNonce](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[calculateUserOperationMaxGasCost](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[getBalanceOf](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[getDepositInfo](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[simulateUserOperationWithTenderlyAndCreateShareLink](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utilsTenderly.ts)
...
#### Source code
[simulateUserOperationCallDataWithTenderlyAndCreateShareLink](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utilsTenderly.ts)
...
#### Source code
[simulateSenderCallDataWithTenderlyAndCreateShareLink](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utilsTenderly.ts)
...
#### Source code
[encodeMultiSendCallData](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/account/Safe/multisend.ts)
...
#### Source code
[decodeMultiSendCallData](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/account/Safe/multisend.ts)
...
#### Source code
[fetchGasPrice](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[createCallData](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[getFunctionSelector](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[sendJsonRpcRequest](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[sendEthCallRequest](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[sendEthGetCodeRequest](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[getDelegatedAddress](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils.ts)
...
#### Source code
[createAndSignEip7702DelegationAuthorization](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils7702.ts)
...
#### Source code
[createRevokeDelegationAuthorization](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils7702.ts)
...
#### Source code
[createEip7702DelegationAuthorizationHash](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils7702.ts)
...
#### Source code
[createAndSignEip7702RawTransaction](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils7702.ts)
...
#### Source code
[createEip7702TransactionHash](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/utils7702.ts)
