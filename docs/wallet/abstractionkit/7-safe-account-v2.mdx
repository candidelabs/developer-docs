...
<TabItem value="Param type" label="Param Types">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td align="left">
          CreateUserOperationOverrides, optional object
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td>UserOperation</td>
        <td align="left">
          <div>{`Promise<UserOperation | JsonRpcError | BundlerJsonRpcError>`}</div>
          <div>UserOperation object</div>
          <DataTable items={userOperationReturnParamsV06} />
          <div>JsonRpcError object</div>
          <DataTable items={jsonRpcErrorType} />
          <div>BundlerJsonRpcError object</div>
