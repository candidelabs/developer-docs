...
Wallets applications integrating Candide's [Social Recovery Module](https://github.com/candidelabs/candide-contracts), and want to offer a seamless and secure recovery experience for their end-users.

## Features

### Authentication-Based Recovery Guardian 
...
combined with other guardians (such as hardware wallets or trusted contacts) to create a customized recovery threshold.
