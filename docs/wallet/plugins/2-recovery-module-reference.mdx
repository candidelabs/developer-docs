    ...
    <tr>
      ...
      <tbody>
        <tr>
          ...
          <td align="left">
            <p><span style={{ color: "#22c916" }}>MetaTransaction</span></p>
...
<Tabs>
  <TabItem value="Param type" label="Param Types">
    <DataTable items={createStandardRevokeGuardianWithThresholdParams} />
  </TabItem>
  <TabItem value="Return type" label="Return Types">
    <table>
      <thead>
...
<Tabs>
  <TabItem value="Param type" label="Param Types">
    <DataTable items={getRecoveryHashParams} />
  </TabItem>
  <TabItem value="Return type" label="Return Types">
    <p>Promise&lt;string&gt;</p>
  </TabItem>
...
<Tabs>
  <TabItem value="Param type" label="Param Types">
    <DataTable items={getRecoveryRequestEip712DataParams} />
  </TabItem>
  <TabItem value="Return type" label="Return Types">
    <p>Promise&lt;object&gt;</p>
    <p>Object containing domain, types, and messageValue for EIP-712 signing.</p>
  </TabItem>
</Tabs>
...
<DataTable items={RecoverySignaturePairParams} />
