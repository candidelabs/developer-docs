...
:::tip
Prefer to run a simple example? Fork this repo and add your first guardian [here](https://github.com/candidelabs/abstractionkit/tree/main/examples/SafeAccountExamples/SocialRecovery). 
:::
