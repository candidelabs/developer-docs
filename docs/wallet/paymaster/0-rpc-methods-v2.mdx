...
:::info V2 API
V3, which implements the standard ERC-7677 methods, is the current Paymaster API. V2 remains fully supported for existing integrations. See the [Paymaster V3 RPC methods](/wallet/paymaster/rpc-methods/).
:::
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="left">
        <p>Object[]</p>
        <DataTable items={tokensParametersV2} />
      </td>
    </tr>
  </tbody>
</table>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td align="left">
          <code>
            <span style={{ color: "#e25894" }}>string</span>
          </code>
        </td>
        <td align="left">
