...
The Paymaster API for Entrypoint v0.8 is fully backword compatible and has no breaking changes from Entrypoint v0.7
...
[ERC-7677](https://eips.ethereum.org/EIPS/eip-7677) compatible method. Equivilant to Candide's [`pm_sponsorUserOperation`](/wallet/paymaster/rpc-methods/#pm_sponsoruseroperation).
...
[ERC-7677](https://eips.ethereum.org/EIPS/eip-7677) compatible method. Equivilant to Candide's [`pm_sponsorUserOperation`](/wallet/paymaster/rpc-methods/#pm_sponsoruseroperation-1).
It can return `isFinal: true` if the stub data is sufficient and no further data is needed. 
