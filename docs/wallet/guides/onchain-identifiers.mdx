...
View the identifier generation in the [generateOnChainIdentifier](https://github.com/candidelabs/abstractionkit/blob/v0.3.3/src/account/Safe/SafeAccount.ts#L3354) source code.
