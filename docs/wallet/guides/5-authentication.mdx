...
Visit the dedicated [Multisig guide](/wallet/guides/multisig/).
...
Traditional wallets encrypts the private key in local storage. In this setup, the owner of the smart account is represented by it. Use [signUserOperation](/wallet/abstractionkit/safe-unified-account/#signuseroperation).
