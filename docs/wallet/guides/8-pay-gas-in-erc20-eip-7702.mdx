...
description: Learn how to upgrade an EOA to an EIP-7702 Smart Account and let users pay gas in ERC-20s using paymasters  
...
Enable users to pay gas in ERC-20 tokens using any [supported ERC-20 token](/wallet/paymaster/tokens-supported/) on Candide Paymaster.
