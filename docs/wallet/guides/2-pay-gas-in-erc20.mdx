...
- If you need, fork the full example of this tutorial on on [Github](https://github.com/candidelabs/abstractionkit/tree/main/examples/SafeAccountExamples/CreateAccountAndSendTransactionUsingTokenPaymaster)
