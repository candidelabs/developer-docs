...
```bash
npm install abstractionkit@0.2.17 dotenv ethers
```

:::note
```abstractionkit@0.2.17``` is the version release with EIP-7702 support before the official upgrade with Pectra.
:::
