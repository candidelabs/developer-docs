...
Here's the [complete code](https://github.com/candidelabs/abstractionkit/tree/main/examples/SimpleAccount/UpgradeEOAto7702SimpleAccountAndSendTransactionWithSponsorPaymaster) for you to reference if you prefer to run directly.
...
Optionally sponsor gas for your user transaction or offer them to pay [gas in erc-20 tokens](/wallet/guides/pay-gas-in-erc20/#step-5-get-paymaster-data) 
