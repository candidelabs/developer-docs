...
To learn more about EIP-7702, visit the dedicated [7702 Overview](/docs/account-abstraction/7702/1-overview.mdx).
...
- Holesky ETH from Faucets. Shoot us on [discord](https://discord.gg/7Xb6ECfNFZ) if you need some
...
:::note
```abstractionkit@0.2.14``` is experimental version release with EIP-7702 before the official upgrade in Pectra.
:::
...
a minimal account that features batching and gas sponsorship.
