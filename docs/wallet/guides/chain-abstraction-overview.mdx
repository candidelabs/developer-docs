...
<div style={{ position: "relative", paddingBottom: "56.25%", height: 0, overflow: "hidden", borderRadius: "8px", marginBottom: "1rem" }}>
  <iframe
    ...
    src="https://www.youtube.com/embed/VF-hI0dvA2o?si=KHK1hRXJoJJ5zSCH"
    title="Safe Unified Account: consolidate USDC/USDT across chains with one signature"
    frameBorder="0"
...
Install the Candide skills so your AI agent knows how to wire up the Safe Unified Account. Source: [github.com/candidelabs/skills](https://github.com/candidelabs/skills).
