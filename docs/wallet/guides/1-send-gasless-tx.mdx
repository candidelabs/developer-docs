...
Learn how to sponsor gas fees for UserOperations using Candide's Paymaster [InstaGas](/instagas/overview/), with both public and private gas policies. 

 
> If you need help with the basics of smart accounts, start with the [Getting Started Guide](/wallet/guides/getting-started/).
...
3. Configure sponsorship rules - Set [rules and conditions](/instagas/gas-policies/) for which transactions to sponsor
