---
title: How to sign messages using a Safe Account and validate them
description: Learn how to sign messages using Safe wallet and verify its signature using EIP-1271 Signature Validation
