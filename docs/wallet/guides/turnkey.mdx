...
description: Learn how to offer a recovery option for your users using Turnkey and AbstractionKit
keywords: ["turnkey", "email recovery", "smart wallet recovery"]
---
import Tabs from "@theme/Tabs";
import TabItem from "@theme/TabItem";

:::tip Recommended: Candide Email / SMS Recovery
Candide now offers a managed recovery service with email and SMS verification, removing the need for third-party key management providers. See the [Email / SMS Recovery guide](/wallet/plugins/add-candide-guardian) for the recommended approach.
:::
