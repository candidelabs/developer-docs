...
:::info
Looking for a simpler approach? Candide offers a managed [Email / SMS Recovery](/wallet/plugins/add-candide-guardian) service that handles key management for you.
:::
