...
Install the Candide skills so your AI agent knows how to wire up the Forwarding Address API. Source: [github.com/candidelabs/skills](https://github.com/candidelabs/skills).
