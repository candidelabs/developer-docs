...
```bash
claude -p "Read https://docs.candide.dev/forwarding-address-agent-skill.md and integrate the Forwarding Address API"
```
...
```bash
codex "Read https://docs.candide.dev/forwarding-address-agent-skill.md and integrate the Forwarding Address API"
```
