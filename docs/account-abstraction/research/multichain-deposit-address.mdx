...
Paste this into your agent to integrate the Forwarding Address API:

<Tabs>
<TabItem value="claude" label="Claude Code">

```bash
curl -s https://docs.candide.dev/forwarding-address-agent-skill.md | claude -p "Integrate the Forwarding Address API using this skill reference"
```
...
```bash
curl -s https://docs.candide.dev/forwarding-address-agent-skill.md | codex -q "Integrate the Forwarding Address API using this skill reference"
```

</TabItem>
<TabItem value="chat" label="Chat Agents">

Paste this into Cursor, Windsurf, Copilot, or any chat-based agent:

```
Fetch https://docs.candide.dev/forwarding-address-agent-skill.md and use it to integrate the Forwarding Address API
```

</TabItem>
<TabItem value="raw" label="Raw URL">

```
https://docs.candide.dev/forwarding-address-agent-skill.md
```
...
**Demo**: [forwarding-address.candidelabs.com](https://forwarding-address.candidelabs.com)
